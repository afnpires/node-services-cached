...
namespace CustomNodeServices.Cache
{
    public class HttpNodeInstance : OutOfProcessNodeInstance
    {
                ...
                options.DebuggingPort)
        {
            ...
            {
                Timeout = TimeSpan.FromMilliseconds(options.InvocationTimeoutMilliseconds + 1000)
            };
        }
